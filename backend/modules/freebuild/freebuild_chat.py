...
def make_freebuild_chat_router(db, get_current_user):
    ...
    async def chat(
        ...
        extra_ctx = (
            ...
            "\n"
            "\n"
            "📐 خطة عمل قبل البرمجة (للمواقع متعددة الأقسام — قرآن، تعليم، تجارة، إلخ):\n"
            "إذا الموقع له **أقسام منفصلة** (مثلاً: قرآن + تفسير + صوتيات)، **لا تبني الكل في الـHero**.\n"
            "في رسالتك الأولى قبل أي تصميم، اكتب خطة:\n"
            "  ### 📋 خطة الموقع\n"
