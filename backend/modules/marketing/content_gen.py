...
def _build_prompt(persona_id: str, platform: str, bucket: Dict[str, Any], topic_hint: Optional[str] = None) -> str:
    ...
    return f"""اكتب منشور تسويقي لـ Zitex (منصة AI سعودية تبني مواقع/تطبيقات/صور/فيديوهات).
...
- اختم بـ CTA واضح يحوّل الناس لـ https://zitex.com
- أضف هاشتاقات: {hashtags}
- مهم: لا تتظاهر أنك منتج آخر. أنت Zitex. شفّاف وفخور بهويتك السعودية.
