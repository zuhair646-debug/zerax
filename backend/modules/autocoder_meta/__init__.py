...
RECOMMENDED_INTEGRATIONS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "why_ar": "مساعد صوتي/فيديو حي داخل Zenrex مع avatar ومقاطعة صوتية realtime.",
...
CAPABILITIES: List[Dict[str, Any]] = [
    {"area": "code", "level": "strong", "items": ["قراءة وتعديل كود Zenrex", "إنشاء backend modules", "إنشاء صفحات React", "اختبار lint/build/endpoints", "commit/push/rollback"]},
...
def _score_readiness(providers: List[Dict[str, Any]], integrations: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    if score >= 95 and not critical_missing:
        ...
        verdict_ar = "قوي لكن غير مكتمل: أقدر أنفذ وأطور Zenrex، لكن لا أقدر أقول مكتمل بالكامل قبل إغلاق النواقص الحرجة."
    else:
        maturity = "foundation"
...
def _build_report(owner: Dict[str, Any] | None = None) -> Dict[str, Any]:
    ...
    return {
        ...
        "readiness": readiness,
        "summary_ar": (
            "برمجة زيتاكس قادر حالياً على تطوير Zenrex end-to-end: كود، اختبارات، نشر، مراقبة، وذكاء متعدد النماذج. "
