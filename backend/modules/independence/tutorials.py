...
RAILWAY_TUTORIAL = {
    ...
    "steps_ar": [
        ...
        "سجّل دخول وافتح المشروع (Zenrex)",
...
TUTORIALS: Dict[str, Dict[str, Any]] = {
    "openrouter": {
        ...
        "steps_ar": [
            ...
            "اضغط 'Create Key' فوق",
            "اكتب اسم للمفتاح (مثلاً: Zenrex Production)",
    ...
    "anthropic": {
        ...
        "steps_ar": [
            ...
            "اكتب اسم (مثلاً: Zenrex)، اختر Permissions = All",
    ...
    "railway": {
        ...
        "steps_ar": [
            ...
            "اكتب اسم (مثلاً: Zenrex Auto-Coder)",
    ...
    "telegram": {
        ...
        "steps_ar": [
            ...
            "اكتب /newbot",
            "اعطه اسم البوت (مثلاً: Zenrex Notifier)",
            "اعطه username ينتهي بـ bot (مثلاً: zenrex_alerts_bot)",
