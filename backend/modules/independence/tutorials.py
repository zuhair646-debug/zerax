...
TUTORIALS: Dict[str, Dict[str, Any]] = {
    "openrouter": {
        ...
        "steps_ar": [
            ...
            "اضغط 'Create Key' فوق",
            "اكتب اسم للمفتاح (مثلاً: Zitex Production)",
    ...
    "anthropic": {
        ...
        "steps_ar": [
            ...
            "اكتب اسم (مثلاً: Zitex)، اختر Permissions = All",
    ...
    "railway": {
        ...
        "steps_ar": [
            ...
            "اكتب اسم (مثلاً: Zitex Auto-Coder)",
    ...
    "telegram": {
        ...
        "steps_ar": [
            ...
            "اكتب /newbot",
            "اعطه اسم البوت (مثلاً: Zitex Notifier)",
