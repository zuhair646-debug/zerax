...
# Maximum git commits per chat session (prevents infinite commit-spam loops).
# High enough for real refactor sessions, low enough to catch runaway AI.
MAX_COMMITS_PER_SESSION = 15
...
- عندك حد أقصى **15 commit في الجلسة** (حماية ضد الـloops). لو وصلت 10، **خفّف الإيقاع** وفكّر قبل ما تكمل.
