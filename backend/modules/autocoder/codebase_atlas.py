"""
Codebase Atlas — pre-loaded knowledge map of the Zenrex platform.
...
FRONTEND_PAGES = {
    ...
    "Companion.js": "/companion — الرفيق Zenrex Companion",
...
FRONTEND_COMPONENTS = {
    ...
    "ZenrexDuo.js + ZenrexDuoLauncher.js": "زوج الـAI المساعد العائم",
...
BACKEND_MODULES = {
    ...
    "companion":    "Zenrex Companion + scheduler",
    "games":        "ألعاب",
