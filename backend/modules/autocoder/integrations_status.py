...
# All integrations Zitex *could* use, their env-var names, and how to obtain.
...
async def tool_integrations_status(category: Optional[str] = None) -> Dict[str, Any]:
    """List ALL Zitex integrations and which env-vars are configured.
...
INTEGRATIONS_ANTHROPIC_TOOLS: List[Dict[str, Any]] = [
    {
        ...
        "description": "📊 اعرض حالة كل تكاملات Zitex (LLM، دفع، تخزين، realtime…) — وش مهيأ ووش ناقص. اختياري filter بالـcategory.",
