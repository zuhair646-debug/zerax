 ...
 *                          (stored in localStorage as `zenrex_lang_manual`).
...
const KEY_MANUAL = 'zenrex_lang_manual';   // user-chosen
const KEY_PERSIST = 'zenrex_lang';          // i18next's persisted key
...
export function getInitialLanguage() {
  ...
  return 'ar'; // Zenrex default — Arabic
}
