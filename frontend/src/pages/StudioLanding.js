...
const STUDIOS = {
  ...
  video_studio: {
    title: 'استوديو الفيديوهات',
    subtitle: 'بنّاء مكتبة فيديوهات من يوتيوب وتيكتوك وإنستا — أكثر من 1000 موقع',
    accent: 'from-fuchsia-500 to-violet-600',
    icon: '🎬',
    bullets: [
      'تنزيل مقاطع من YouTube / TikTok / Instagram / X / Vimeo + 1000 موقع',
      '3 صيغ: 720p, 1080p, MP3 صوت فقط',
      'بناء مكتبة فيديو احترافية بتصميم Zenrex',
      'الـ AI ينظّم كل مقطع بكرت: مشغّل + عنوان + رابط المصدر',
      'دعم الجلسات الخاصة عبر طلب cookies (للحسابات الخاصة)',
    ],
