...
const ClientDashboard = ({ user, setUser }) => {
  ...
  const quickActions = [
    ...
    { title: '🎬 استوديو الفيديو v2', desc: 'سلاسل وحلقات بـستوري بورد قبل الإنتاج', icon: <Clapperboard className="w-6 h-6" />, path: '/chat/video-studio', color: 'from-amber-600 to-orange-700', badge: 'جديد' },
