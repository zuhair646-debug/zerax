...
const VAULTS = [
  ...
  { title: 'المواقع الجاهزة', desc: 'معالج 6 خطوات · 4 أنماط · 24 ميزة (مطاعم)', icon: Globe, path: '/ready-sites', accent: '#f59e0b', gradient: 'from-amber-600/40 to-pink-700/20', bgImage: 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&w=800&q=70' },
